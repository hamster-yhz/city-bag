-- 景点表示例数据
INSERT INTO `scenic_spot` (id, scenic_spot_id, scenic_spot_name, english_name, introduce, image_url,
...
VALUES (NULL, UUID(), '兵马俑', 'Terracotta Army',
       ...
       (NULL, UUID(), '都江堰', 'Dujiangyan',
        ...
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (NULL, UUID(), '中山陵', 'Zhongshan Mausoleum',
        ...
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (NULL, UUID(), '大雁塔', 'Big Wild Goose Pagoda',
       ...
       (NULL, UUID(), '华清池', 'Huaqing Pool',
        ...
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (NULL, UUID(), '钟鼓楼', 'Bell and Drum Towers',
       ...
       (NULL, UUID(), '回民街', 'Hui Street',
        ...
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (NULL, UUID(), '科尔沁大草原', 'Korqin Grassland',
        '科尔沁的著名景点，广阔的草原风光，适合徒步和露营.',
        '',
        '科尔沁大草原',
        '08:00-18:00',
        '免费',
        ...
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (NULL, UUID(), '科尔沁博物馆', 'Korqin Museum',
        '科尔沁的著名景点，展示科尔沁的历史文化，适合文化爱好者.',
        '',
        '科尔沁博物馆',
        '09:00-17:00',
        '30元',
        ...
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (NULL, UUID(), '科尔沁温泉', 'Korqin Hot Springs',
        '科尔沁的著名景点，提供温泉泡澡，适合放松身心.',
        '',
        '科尔沁温泉',
        '08:00-20:00',
        '50元',
        ...
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (NULL, UUID(), '巴音布鲁克草原', 'Bayinbuluk Grassland',
       ...
       (NULL, UUID(), '天鹅湖', 'Swan Lake',
        ...
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (NULL, UUID(), '草原石人', 'Grassland Stone Men',
       ...
       (NULL, UUID(), '开元寺', 'Kaiyuan Temple',
        ...
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (NULL, UUID(), '崇武古城', 'Chongwu Ancient City',
       ...
       (NULL, UUID(), '漓江', 'Li River',
        ...
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (NULL, UUID(), '象鼻山', 'Elephant Trunk Hill',
        '桂林城徽，形似巨象饮水的神奇山峰',
        '',
        '桂林市象山区民主路1号',
        '06:30-19:00',
        ...
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (NULL, UUID(), '龙脊梯田', 'Longji Terraced Fields',
        '世界梯田原乡，壮丽的高山梯田景观',
        '',
        '桂林市龙胜各族自治县',
        '全天开放',
