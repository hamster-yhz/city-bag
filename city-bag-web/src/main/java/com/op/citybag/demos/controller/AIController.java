...
import com.op.citybag.demos.common.DTO.AI.AIDTO;
import com.op.citybag.demos.common.OPResult;
import com.op.citybag.demos.common.OPResultStream;
...
public class AIController {
     ...
     * @return
     */
    @PostMapping("searchPhotos")
    public OPResult searchPhotos(@Valid @RequestBody AIDTO AIDTO) {
        String pexelsSearchResponse = cityService.searchPhotos(AIDTO.getInput());

        return OPResult.SUCCESS(pexelsSearchResponse);
    }
